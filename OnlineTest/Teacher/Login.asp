...
<table  align="center" cellspacing="1" cellpadding="0" border="0" bgcolor="#FFFFFF">
	<tr>
		<td height="30" colspan="2" align="center"><strong>教 师 登 录</strong></td>
	</tr>
	<tr>
		<td width="380" height="28" align="right">账户：</td>
		<td width="551" align="left">&nbsp;<input name="teacherID" class="text" type="text" style="width:150px; height:15px;"></td>
	</tr>
	<tr>
		<td width="380" height="28" align="right">密码：</td>
		<td align="left">&nbsp;<input name="teacherpwd" class="text" type="password" style="width:150px; height:15px;"></td>
	</tr>
	<tr>
