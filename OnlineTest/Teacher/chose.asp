...
<form name="chose" action="action_chose.asp" method="post">
<table cellpadding="0" cellspacing="0" border=0 bordercolor="#FFFFFF" bordercolordark="#1985DB" bordercolorlight="#FFFFFF" align="center" width="100%"> 
                                      <tr align=center> 
                                        ...
                                        <td width="15%" nowrap>A选项</td> 
                                        <td width="15%" nowrap>B选项</td> 
                                        <td width="15%" nowrap>C选项</td> 
                                        <td width="15%" nowrap>D选项</td>
                                        <td width="15%" nowrap>答案</td>
                                      </tr> 
                                      <tr align=center> 
                                        <td height="25" nowrap>
                                        <select name="style_exam" onChange="getURL(this.value)">
                                        <option value="chose" selected>选择题
                                        <option value="ture">判断题
                                        <option value="make">填空题
                                        </select>
                                        </td> 
                                        <td><input type="text" name="problem" align="middle"></td> 
                                        <td><input type="text" name="A" align="middle"></td>
                                        <td><input type="text" name="B" align="middle"></td>
                                        <td><input type="text" name="C" align="middle"></td>
                                        <td><input type="text" name="D" align="middle"></td>
                                        <td><input type="text" name="answer" align="middle"></td>
   									 </tr>                                  
</table>
