...
<table width="768" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <td bgcolor="#58CCE9">&nbsp; <a href="adm_stu.asp">学生信息列表</a> 
    | <a href="add_stu.asp">添加学生信息</a>
  </table>
...
%>
        <table border="0" width="768" bordercolorlight="#000000" cellspacing="1" cellpadding="0" bordercolordark="#FFFFFF">
          <tr>
            <td width="83" height="25" align="center" bgcolor="#F4FBFB">学号</td>
            <td width="84" bgcolor="#F4FBFB" align="center">身份证号</td>
            <td width="84" bgcolor="#F4FBFB" align="center">姓名</td>
            <td width="84" bgcolor="#F4FBFB" align="center">性别</td>
            <td width="84" bgcolor="#F4FBFB" align="center">所在学院</td>
            <td width="84" bgcolor="#F4FBFB" align="center">修改</td>
            <td width="77" bgcolor="#F4FBFB" align="center">删除</td>
          </tr>
...
%>
          ...
          <tr>
            <td width="83" height="25" align="center"><%=rst("studentID")%></td>
            <td width="84" align="center"><%=rst("card")%></td>
            <td width="84" align="center"><%=rst("name")%></td>
            <td width="84" align="center"><%=rst("sex")%></td>
            <td width="84" align="center"><%=rst("college")%></td>
            <td width="84" align="center"><a href=mod_stu.asp?id=<%=rst("ID")%>>修改</a></td>
            <td width="77" align="center"><a href=del_stu.asp?id=<%=rst("ID")%>>删除</a></td>
          </tr>
           <%		 		rst.movenext
