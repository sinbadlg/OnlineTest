...
%>
        <table border="0" width="768" bordercolorlight="#000000" cellspacing="1" cellpadding="0" bordercolordark="#FFFFFF">
          <tr>
            <td width="83" height="25" align="center" bgcolor="#58CCE9">试卷名称</td>
            <td width="84" align="center" bgcolor="#58CCE9">开始时间</td>
            <td width="84" align="center" bgcolor="#58CCE9">结束时间</td>
            <td width="84" align="center" bgcolor="#58CCE9">考试用时</td>
...
%>
          ...
          <tr>
            ...
            <td width="84" align="center"><a href=mod_paper.asp?id=<%=rst("ID")%>>修改</a></td>
            <td width="77" align="center"><a href=del_paper.asp?id=<%=rst("ID")%>>删除</a></td>
          </tr>
           <%		 		rst.movenext
