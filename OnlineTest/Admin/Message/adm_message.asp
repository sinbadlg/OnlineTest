...
<table width="768" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <td bgcolor="#58CCE9">&nbsp; <a href="adm_message.asp">公告列表</a> 
    | <a href="add_message.asp">添加公告</a>
  </table>
...
%>
        <table border="0" width="768" bordercolorlight="#000000" cellspacing="1" cellpadding="0" bordercolordark="#FFFFFF">
          <tr>
            <td width="220" height="25" align="center" bgcolor="#F4FBFB">公告内容</td>
            <td width="25" bgcolor="#F4FBFB" align="center">修改</td>
            <td width="25" bgcolor="#F4FBFB" align="center">删除</td>
          </tr>
...
%>
          ...
          <tr>
            ...
            <td width="25" align="center"><a href=mod_message.asp?id=<%=rst("ID")%>>修改</a></td>
            <td width="25" align="center"><a href=del_message.asp?id=<%=rst("ID")%>>删除</a></td>
          </tr>
           <%		 		rst.movenext
